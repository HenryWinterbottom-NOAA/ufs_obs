...
# Script: scripts/compute_cimss_adt_atcf.py
...
from exceptions import CIMSSADTATCFError
...
class ComputeCIMSSADTATCF:
    ...
    def __init__(self, options_obj: object):
        ...
        Creates a new ComputeCIMSSADTATCF object.
...
def main():
    ...
    # Launch the task.
    task = ComputeCIMSSADTATCF(options_obj=options_obj)
    task.run()
